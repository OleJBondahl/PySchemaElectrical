...
|------|------|----------|-------|
| `src/schematika/symbols/blocks.py` | 20 | `terminal_box_symbol()` | `pins: tuple[str, ...] \| None = None` — should be `= ()` |
| `src/schematika/symbols/blocks.py` | 115 | `psu_symbol()` | `pins: tuple[str, ...] \| None = None` — should be `= ()` |
...
| `example_pin_configurations.py` | BROKEN | `ModuleNotFoundError: No module named 'schematika.std_circuits'` |
