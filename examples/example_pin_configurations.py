...
print(f"✓ Auto-numbered DOL starter saved")
...
render_system(combined_circuit, "examples/output/dol_pins_example2_shared_state.svg")
print(f"✓ Two DOL starters with shared autonumbering saved")
print(f"  First circuit terminals: {terminals2a}")
print(f"  Second circuit terminals: {terminals2b}")
print(f"  Notice how X1 pins continue: 1,2,3 then 4,5,6")
print()
...
print(f"✓ DOL starter with custom pins saved")
print(f"  Used terminals: {terminals3}")
print(f"  Input terminal pins: L1, L2, L3 (instead of auto 1,2,3)")
print(f"  Output terminal pins: U, V, W (instead of auto 1,2,3)")
print(f"  Circuit breaker pins: Custom IEC nomenclature")
print(f"  Thermal overload pins: All hidden")
print(f"  Contactor pins: Using NO/NC notation")
print(f"  CT pins: Custom S1, S2, K, L labels")
print()
...
print(f"✓ DOL starter with mixed approach saved")
print(f"  Used terminals: {terminals4}")
print(f"  Terminal pins: Auto-numbered (default)")
print(f"  Symbol pins: Partially customized")
print()
...
print("  2. examples/output/dol_pins_example2_shared_state.svg - Shared state across circuits")
